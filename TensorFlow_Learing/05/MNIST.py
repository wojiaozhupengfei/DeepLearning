#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2018/9/12/0012 9:05
# @Author  : zhupengfei
# @Site    : 
# @File    : MNIST.py
# @Software: PyCharm
#用一个三层的全连接神经网络实现MNIST数据集的训练 训练集55000  验证集5000 测试集10000
...
def train(mnist):
    ...
    y = interface(x, None, w1, bias1, w2, bias2)
    ...
    y_average = interface(x, variable_averages, w1, bias1, w2, bias2)
